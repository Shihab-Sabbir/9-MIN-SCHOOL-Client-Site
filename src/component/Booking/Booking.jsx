...
function Booking() {
    ...
    return (
        <div className={isMenuOpen ? 'pt-[250px] bg-blue-300' : 'bg-slate-300'}>
            {product?.price ?
                <div className="relative px-4 pt-16 mx-auto lg:py-32 md:px-8 xl:px-20 sm:max-w-xl md:max-w-full min-h-screen">
                    ...
                    <div className="flex justify-center h-full p-3 overflow-hidden lg:w-2/3 xl:w-1/2 lg:absolute lg:justify-start lg:bottom-0 lg:right-0 lg:items-end lg:pb-3 pb-10">
                        <div className="h-auto w-80 bg-white p-3 rounded-lg shadow-2xl">
                            ...
                            <p className="text-lg text-center mt-4 text-gray-600 font-semibold">Payment amount:${product.cost || 0}</p>
