        ...
        <div className={(window.location.pathname !== '/') ? 'dark:bg-gray-900 bg-gray-500 z-[200] min-h-fit' : ' bg-transparent dark:bg-transparent min-h-fit absolute min-w-full bg-opacity-0'}>
            <div className="px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
                <div className="relative flex items-center justify-between">
                            ...
                            <form className='rounded-lg lg:min-w-[280px]' onSubmit={handleSearchInput}>
                                <div className="flex rounded-lg">
                                    ...
                                    <div className="relative w-full">
                                        <input type="search" id="search-dropdown" name='search' className="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-r-lg rounded-l-lg border-l-gray-50 border-l-2 border border-gray-300 focus:ring-gray-500 focus:border-gray-500 dark:bg-gray-700 dark:border-l-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-gray-500" placeholder="Search Courses..." required="" />
                    ...
                    <div className='hidden lg:block border-2 px-1 rounded-md'>
