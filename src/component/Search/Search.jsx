        ...
        <div className={isMenuOpen ? 'pt-[350px]' : ''}>
            <div className='flex flex-col justify-center items-center px-4 pt-4'>
                ...
                {data?.length > 0 &&
                    <>
                        {data?.length === 1 ?
                            <p className='mb-3 text-xs !text-left font-bold uppercase'>Only {data?.length} course has been found</p>
                            :
                            <p className='mb-3 text-xs !text-left font-bold uppercase'>Total {data?.length} courses have been found</p>
                        }
