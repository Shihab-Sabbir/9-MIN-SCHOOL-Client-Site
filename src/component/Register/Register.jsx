            ...
            <div className="dark:bg-gray-300 bg-gray-100  rounded-b-lg py-12 px-4 lg:px-24 rounded-lg ">
                ...
                <form className="mt-6" onSubmit={handleSubmit}>
                    <div className="relative">
                        <input required className="appearance-none border pl-12 border-gray-100 shadow-sm focus:shadow-md dark:bg-gray-100 focus:placeholder-gray-600  transition  rounded-md w-full py-3 text-gray-600 leading-tight focus:outline-none focus:ring-gray-600 focus:shadow-outline" id="username" type="text" name='name' placeholder="Full Name" />
                    ...
                    <div className="relative mt-3">
                        <input required className="appearance-none border pl-12 border-gray-100 shadow-sm focus:shadow-md dark:bg-gray-100 focus:placeholder-gray-600  transition  rounded-md w-full py-3 text-gray-600 leading-tight focus:outline-none focus:ring-gray-600 focus:shadow-outline" id="photoURL" type="url" name='photo' placeholder="Photo URL" />
                        <div className="absolute left-0 inset-y-0 flex items-center">
                    ...
                    <div className="relative mt-3">
                        <input required className="appearance-none border pl-12 border-gray-100 shadow-sm focus:shadow-md dark:bg-gray-100 focus:placeholder-gray-600  transition  rounded-md w-full py-3 text-gray-600 leading-tight focus:outline-none focus:ring-gray-600 focus:shadow-outline" id="email" name='email' type="email" placeholder="Email" />
                        <div className="absolute left-0 inset-y-0 flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 ml-3 text-gray-400 p-1" viewBox="0 0 20 20" fill="currentColor">
                                <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" />                     <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
                            </svg>
                    ...
                    <div className="relative mt-3">
                        <input className="appearance-none border pl-12 border-gray-100 shadow-sm focus:shadow-md dark:bg-gray-100 focus:placeholder-gray-600  transition  rounded-md w-full py-3 text-gray-600 leading-tight focus:outline-none focus:ring-gray-600 focus:shadow-outline" id="password" name='password' type="password" placeholder="Password" />
                        <div className="absolute left-0 inset-y-0 flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 ml-3 text-gray-400 p-1" viewBox="0 0 20 20" fill="currentColor"            >
